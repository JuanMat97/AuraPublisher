...
export function renderSmartMoldComposite(options: RenderSmartMoldOptions): HTMLCanvasElement {
  ...
  return renderWebGLRoomComposite({
    ...
    reflectionType: mold.reflectionType ?? 'panoramic_window',
    ...
    ceilingLightsEnabled: mold.ceilingLightsEnabled,
    ceilingLightTemp: mold.ceilingLightTemp,
    sunIntensity: mold.sunIntensity ?? 100,
    wallQuad: mold.wallQuad,
    isWallAnchored: mold.isWallAnchored,
    wallCalibratedAngle: mold.wallCalibratedAngle,
    wallCalibratedPitch: mold.wallCalibratedPitch,
    adjust: mold.adjust,
    adjustBg: mold.adjustBg,
    bgAdjust: mold.bgAdjust || mold.adjustBg,
    vignette: mold.vignette,
