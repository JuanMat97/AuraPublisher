  ...
  for (const sel of selectedPositions) {
    ...
    const canvas = renderSmartMoldComposite({
      ...
      mold: {
        ...
        adjust: {
          temperature: productConfig.temperature,
          tint: productConfig.tint,
          brightness: productConfig.brightness,
          contrast: productConfig.contrast,
          highlights: productConfig.highlights,
          shadowsTone: productConfig.shadowsTone,
          whites: productConfig.whites,
          blacks: productConfig.blacks,
          hue: productConfig.hue,
          saturation: productConfig.saturation,
          invert: productConfig.invert,
        },
        shadowPreset: pos.shadowPreset ?? productConfig.shadowPreset,
        shadowAngleDeg: productConfig.shadowAngleDeg,
        shadowDistance: productConfig.shadowDistance,
        shadowBlur: pos.shadowBlur ?? productConfig.shadowBlur,
        shadowIntensity: pos.shadowStyleIntensity ?? productConfig.shadowIntensity,
